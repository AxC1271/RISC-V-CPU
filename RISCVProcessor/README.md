...
Here, I've provided a ![working demo]([./RISC-VCPUDemo.mov](https://youtu.be/ghEym8AjQQo) of the RISC-V processor handling the following assembly file. I want the FPGA board to "print" the first ten Fibonacci numbers.
